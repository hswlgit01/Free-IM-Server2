...
var (
	...
	ErrGroupJoinDisabled        = errs.NewCodeError(GroupJoinDisabledError, "GroupJoinDisabledError")
	ErrOfficialAccountProtected = errs.NewCodeError(OfficialAccountProtected, "OfficialAccountProtected")
	...
	ErrDifferentOrg        = errs.NewCodeError(DifferentOrgError, "DifferentOrgError")
