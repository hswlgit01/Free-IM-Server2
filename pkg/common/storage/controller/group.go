...
type GroupDatabase interface {
	...
	FindGroupByOrg(ctx context.Context, groupIDs []string, orgID string) (groups []*model.Group, err error)
...
func (g *groupDatabase) FindGroupByOrg(ctx context.Context, groupIDs []string, orgID string) (groups []*model.Group, err error) {
	return g.cache.GetGroupsInfo(ctx, groupIDs)
}
