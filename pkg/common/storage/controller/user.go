...
type UserDatabase interface {
	...
	// Get user AES key by userID
	GetUserAESKey(ctx context.Context, userID string) (aesKey string, err error)
...
// GetUserAESKey 获取用户的AES密钥，使用缓存
func (u *userDatabase) GetUserAESKey(ctx context.Context, userID string) (aesKey string, err error) {
	return u.cache.GetUserAESKey(ctx, userID)
}
