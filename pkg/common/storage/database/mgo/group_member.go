...
func (g *GroupMemberMgo) memberSort() any {
	//return bson.M{"role_level": -1, "join_time": -1, "nickname": 1}
	return bson.D{{Key: "role_level", Value: -1}, {Key: "join_time", Value: -1}, {Key: "nickname", Value: 1}}
}
...
func (g *GroupMemberMgo) Find(ctx context.Context, groupID string, userIDs []string) ([]*model.GroupMember, error) {
	...
	opts := options.Find().SetSort(g.memberSort())
	return mongoutil.Find[*model.GroupMember](ctx, g.coll, filter, opts)
}
