...
const (
	...
	User_GetUserAESKey_FullMethodName                 = "/openim.user.user/getUserAESKey"
)
...
type UserClient interface {
	...
	GetUserAESKey(ctx context.Context, in *GetUserAESKeyReq, opts ...grpc.CallOption) (*GetUserAESKeyResp, error)
}
...
func (c *userClient) GetUserAESKey(ctx context.Context, in *GetUserAESKeyReq, opts ...grpc.CallOption) (*GetUserAESKeyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserAESKeyResp)
	err := c.cc.Invoke(ctx, User_GetUserAESKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserAESKey(context.Context, *GetUserAESKeyReq) (*GetUserAESKeyResp, error)
...
func (UnimplementedUserServer) GetUserAESKey(context.Context, *GetUserAESKeyReq) (*GetUserAESKeyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserAESKey not implemented")
}
...
func _User_GetUserAESKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserAESKeyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserAESKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserAESKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserAESKey(ctx, req.(*GetUserAESKeyReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getUserAESKey",
			Handler:    _User_GetUserAESKey_Handler,
		},
	},
