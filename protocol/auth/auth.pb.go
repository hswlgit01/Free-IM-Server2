...
type GetAdminTokenReq struct {
	...
	RsaEncryptSecret string                 `protobuf:"bytes,4,opt,name=rsaEncryptSecret,proto3" json:"rsaEncryptSecret,omitempty"`
...
func (x *GetAdminTokenReq) GetRsaEncryptSecret() string {
	if x != nil {
		return x.RsaEncryptSecret
	}
	return ""
}
...
type BatchForceLogoutReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*ForceLogoutItem     `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchForceLogoutReq) Reset() {
	*x = BatchForceLogoutReq{}
	mi := &file_protocol_auth_auth_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchForceLogoutReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchForceLogoutReq) ProtoMessage() {}

func (x *BatchForceLogoutReq) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_auth_auth_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchForceLogoutReq.ProtoReflect.Descriptor instead.
func (*BatchForceLogoutReq) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{4}
}

func (x *BatchForceLogoutReq) GetItems() []*ForceLogoutItem {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *ForceLogoutItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForceLogoutItem) ProtoMessage() {}

func (x *ForceLogoutItem) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_auth_auth_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ForceLogoutItem.ProtoReflect.Descriptor instead.
func (*ForceLogoutItem) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{5}
}

func (x *ForceLogoutItem) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *ForceLogoutItem) GetPlatformID() int32 {
	if x != nil {
		return x.PlatformID
	}
	return 0
...
type BatchForceLogoutResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchForceLogoutResp) Reset() {
	*x = BatchForceLogoutResp{}
	mi := &file_protocol_auth_auth_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchForceLogoutResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchForceLogoutResp) ProtoMessage() {}

func (x *BatchForceLogoutResp) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_auth_auth_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchForceLogoutResp.ProtoReflect.Descriptor instead.
func (*BatchForceLogoutResp) Descriptor() ([]byte, []int) {
...
func (x *ParseTokenReq) Reset() {
	*x = ParseTokenReq{}
	mi := &file_protocol_auth_auth_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ParseTokenReq) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{7}
}
...
func (x *ParseTokenResp) Reset() {
	*x = ParseTokenResp{}
	mi := &file_protocol_auth_auth_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ParseTokenResp) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetUserTokenReq) Reset() {
	*x = GetUserTokenReq{}
	mi := &file_protocol_auth_auth_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserTokenReq) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{9}
}
...
func (x *GetUserTokenResp) Reset() {
	*x = GetUserTokenResp{}
	mi := &file_protocol_auth_auth_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserTokenResp) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{10}
}
...
func (x *InvalidateTokenReq) Reset() {
	*x = InvalidateTokenReq{}
	mi := &file_protocol_auth_auth_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InvalidateTokenReq) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{11}
}
...
func (x *InvalidateTokenResp) Reset() {
	*x = InvalidateTokenResp{}
	mi := &file_protocol_auth_auth_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InvalidateTokenResp) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{12}
}
...
func (x *KickTokensReq) Reset() {
	*x = KickTokensReq{}
	mi := &file_protocol_auth_auth_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KickTokensReq) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{13}
}
...
func (x *KickTokensResp) Reset() {
	*x = KickTokensResp{}
	mi := &file_protocol_auth_auth_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KickTokensResp) Descriptor() ([]byte, []int) {
	return file_protocol_auth_auth_proto_rawDescGZIP(), []int{14}
}

var File_protocol_auth_auth_proto protoreflect.FileDescriptor

const file_protocol_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x18protocol/auth/auth.proto\x12\vopenim.auth\"n\n" +
	"\x10getAdminTokenReq\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x16\n" +
	"\x06userID\x18\x03 \x01(\tR\x06userID\x12*\n" +
	"\x10rsaEncryptSecret\x18\x04 \x01(\tR\x10rsaEncryptSecret\"W\n" +
	...
	"\x0fforceLogoutResp\"I\n" +
	"\x13batchForceLogoutReq\x122\n" +
	"\x05items\x18\x01 \x03(\v2\x1c.openim.auth.ForceLogoutItemR\x05items\"I\n" +
	"\x0fForceLogoutItem\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x1e\n" +
	"\n" +
	"platformID\x18\x02 \x01(\x05R\n" +
	"platformID\"\x16\n" +
	"\x14batchForceLogoutResp\"%\n" +
	...
	"\vforceLogout\x12\x1b.openim.auth.forceLogoutReq\x1a\x1c.openim.auth.forceLogoutResp\x12W\n" +
	"\x10batchForceLogout\x12 .openim.auth.batchForceLogoutReq\x1a!.openim.auth.batchForceLogoutResp\x12E\n" +
	"\n" +
	...
	"\n" +
	"kickTokens\x12\x1a.openim.auth.kickTokensReq\x1a\x1b.openim.auth.kickTokensRespB6Z4github.com/openimsdk/open-im-server/v3/protocol/authb\x06proto3"

var (
	file_protocol_auth_auth_proto_rawDescOnce sync.Once
	file_protocol_auth_auth_proto_rawDescData []byte
)

func file_protocol_auth_auth_proto_rawDescGZIP() []byte {
	file_protocol_auth_auth_proto_rawDescOnce.Do(func() {
		file_protocol_auth_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protocol_auth_auth_proto_rawDesc), len(file_protocol_auth_auth_proto_rawDesc)))
	})
	return file_protocol_auth_auth_proto_rawDescData
}

var file_protocol_auth_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_protocol_auth_auth_proto_goTypes = []any{
	...
	(*BatchForceLogoutReq)(nil),  // 4: openim.auth.batchForceLogoutReq
	(*ForceLogoutItem)(nil),      // 5: openim.auth.ForceLogoutItem
	(*BatchForceLogoutResp)(nil), // 6: openim.auth.batchForceLogoutResp
	(*ParseTokenReq)(nil),        // 7: openim.auth.parseTokenReq
	(*ParseTokenResp)(nil),       // 8: openim.auth.parseTokenResp
	(*GetUserTokenReq)(nil),      // 9: openim.auth.getUserTokenReq
	(*GetUserTokenResp)(nil),     // 10: openim.auth.getUserTokenResp
	(*InvalidateTokenReq)(nil),   // 11: openim.auth.invalidateTokenReq
	(*InvalidateTokenResp)(nil),  // 12: openim.auth.invalidateTokenResp
	(*KickTokensReq)(nil),        // 13: openim.auth.kickTokensReq
	(*KickTokensResp)(nil),       // 14: openim.auth.kickTokensResp
}
var file_protocol_auth_auth_proto_depIdxs = []int32{
	5,  // 0: openim.auth.batchForceLogoutReq.items:type_name -> openim.auth.ForceLogoutItem
	0,  // 1: openim.auth.Auth.getAdminToken:input_type -> openim.auth.getAdminTokenReq
	9,  // 2: openim.auth.Auth.getUserToken:input_type -> openim.auth.getUserTokenReq
	2,  // 3: openim.auth.Auth.forceLogout:input_type -> openim.auth.forceLogoutReq
	4,  // 4: openim.auth.Auth.batchForceLogout:input_type -> openim.auth.batchForceLogoutReq
	7,  // 5: openim.auth.Auth.parseToken:input_type -> openim.auth.parseTokenReq
	11, // 6: openim.auth.Auth.invalidateToken:input_type -> openim.auth.invalidateTokenReq
	13, // 7: openim.auth.Auth.kickTokens:input_type -> openim.auth.kickTokensReq
	1,  // 8: openim.auth.Auth.getAdminToken:output_type -> openim.auth.getAdminTokenResp
	10, // 9: openim.auth.Auth.getUserToken:output_type -> openim.auth.getUserTokenResp
	3,  // 10: openim.auth.Auth.forceLogout:output_type -> openim.auth.forceLogoutResp
	6,  // 11: openim.auth.Auth.batchForceLogout:output_type -> openim.auth.batchForceLogoutResp
	8,  // 12: openim.auth.Auth.parseToken:output_type -> openim.auth.parseTokenResp
	12, // 13: openim.auth.Auth.invalidateToken:output_type -> openim.auth.invalidateTokenResp
	14, // 14: openim.auth.Auth.kickTokens:output_type -> openim.auth.kickTokensResp
...
func file_protocol_auth_auth_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protocol_auth_auth_proto_rawDesc), len(file_protocol_auth_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
