...
const (
	...
	Auth_BatchForceLogout_FullMethodName = "/openim.auth.Auth/batchForceLogout"
...
type AuthClient interface {
	...
	// Batch force logout
	BatchForceLogout(ctx context.Context, in *BatchForceLogoutReq, opts ...grpc.CallOption) (*BatchForceLogoutResp, error)
	// Parse token
...
func (c *authClient) BatchForceLogout(ctx context.Context, in *BatchForceLogoutReq, opts ...grpc.CallOption) (*BatchForceLogoutResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchForceLogoutResp)
	err := c.cc.Invoke(ctx, Auth_BatchForceLogout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	// Batch force logout
	BatchForceLogout(context.Context, *BatchForceLogoutReq) (*BatchForceLogoutResp, error)
	// Parse token
...
func (UnimplementedAuthServer) BatchForceLogout(context.Context, *BatchForceLogoutReq) (*BatchForceLogoutResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchForceLogout not implemented")
}
...
func _Auth_BatchForceLogout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchForceLogoutReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).BatchForceLogout(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_BatchForceLogout_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).BatchForceLogout(ctx, req.(*BatchForceLogoutReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "batchForceLogout",
			Handler:    _Auth_BatchForceLogout_Handler,
		},
		{
