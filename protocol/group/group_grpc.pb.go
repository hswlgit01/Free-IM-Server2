...
const (
	...
	Group_CreateGroupOperationLog_FullMethodName          = "/openim.group.group/CreateGroupOperationLog"
)
...
type GroupClient interface {
	...
	// 群操作日志接口（仅admin可调用）
	CreateGroupOperationLog(ctx context.Context, in *CreateGroupOperationLogReq, opts ...grpc.CallOption) (*CreateGroupOperationLogResp, error)
}
...
func (c *groupClient) CreateGroupOperationLog(ctx context.Context, in *CreateGroupOperationLogReq, opts ...grpc.CallOption) (*CreateGroupOperationLogResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateGroupOperationLogResp)
	err := c.cc.Invoke(ctx, Group_CreateGroupOperationLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GroupServer interface {
	...
	// 群操作日志接口（仅admin可调用）
	CreateGroupOperationLog(context.Context, *CreateGroupOperationLogReq) (*CreateGroupOperationLogResp, error)
...
func (UnimplementedGroupServer) CreateGroupOperationLog(context.Context, *CreateGroupOperationLogReq) (*CreateGroupOperationLogResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateGroupOperationLog not implemented")
}
...
func _Group_CreateGroupOperationLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateGroupOperationLogReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GroupServer).CreateGroupOperationLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Group_CreateGroupOperationLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupServer).CreateGroupOperationLog(ctx, req.(*CreateGroupOperationLogReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Group_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateGroupOperationLog",
			Handler:    _Group_CreateGroupOperationLog_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protocol/group/group.proto",
}
