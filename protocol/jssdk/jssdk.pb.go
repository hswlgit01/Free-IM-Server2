...
// 	protoc        v5.29.3
// source: protocol/jssdk/jssdk.proto

package jssdk

import (
	conversation "github.com/openimsdk/open-im-server/v3/protocol/conversation"
	relation "github.com/openimsdk/open-im-server/v3/protocol/relation"
...
func (x *ConversationMsg) Reset() {
	*x = ConversationMsg{}
	mi := &file_protocol_jssdk_jssdk_proto_msgTypes[0]
...
func (*ConversationMsg) Descriptor() ([]byte, []int) {
	return file_protocol_jssdk_jssdk_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetActiveConversationsReq) Reset() {
	*x = GetActiveConversationsReq{}
	mi := &file_protocol_jssdk_jssdk_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetActiveConversationsReq) Descriptor() ([]byte, []int) {
	return file_protocol_jssdk_jssdk_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetActiveConversationsResp) Reset() {
	*x = GetActiveConversationsResp{}
	mi := &file_protocol_jssdk_jssdk_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetActiveConversationsResp) Descriptor() ([]byte, []int) {
	return file_protocol_jssdk_jssdk_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetConversationsReq) Reset() {
	*x = GetConversationsReq{}
	mi := &file_protocol_jssdk_jssdk_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetConversationsReq) Descriptor() ([]byte, []int) {
	return file_protocol_jssdk_jssdk_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetConversationsResp) Reset() {
	*x = GetConversationsResp{}
	mi := &file_protocol_jssdk_jssdk_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetConversationsResp) Descriptor() ([]byte, []int) {
	return file_protocol_jssdk_jssdk_proto_rawDescGZIP(), []int{4}
}
...
var File_protocol_jssdk_jssdk_proto protoreflect.FileDescriptor

const file_protocol_jssdk_jssdk_proto_rawDesc = "" +
	"\n" +
	"\x1aprotocol/jssdk/jssdk.proto\x12\fopenim.jssdk\x1a\x1aprotocol/sdkws/sdkws.proto\x1a protocol/relation/relation.proto\x1a(protocol/conversation/conversation.proto\"\xcf\x02\n" +
	...
	"\vunreadCount\x18\x01 \x01(\x03R\vunreadCount\x12C\n" +
	"\rconversations\x18\x02 \x03(\v2\x1d.openim.jssdk.ConversationMsgR\rconversationsB7Z5github.com/openimsdk/open-im-server/v3/protocol/jssdkb\x06proto3"

var (
	file_protocol_jssdk_jssdk_proto_rawDescOnce sync.Once
	file_protocol_jssdk_jssdk_proto_rawDescData []byte
)

func file_protocol_jssdk_jssdk_proto_rawDescGZIP() []byte {
	file_protocol_jssdk_jssdk_proto_rawDescOnce.Do(func() {
		file_protocol_jssdk_jssdk_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protocol_jssdk_jssdk_proto_rawDesc), len(file_protocol_jssdk_jssdk_proto_rawDesc)))
	})
	return file_protocol_jssdk_jssdk_proto_rawDescData
}

var file_protocol_jssdk_jssdk_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_protocol_jssdk_jssdk_proto_goTypes = []any{
...
var file_protocol_jssdk_jssdk_proto_depIdxs = []int32{
...
func init() { file_protocol_jssdk_jssdk_proto_init() }
func file_protocol_jssdk_jssdk_proto_init() {
	if File_protocol_jssdk_jssdk_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protocol_jssdk_jssdk_proto_rawDesc), len(file_protocol_jssdk_jssdk_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_protocol_jssdk_jssdk_proto_goTypes,
		DependencyIndexes: file_protocol_jssdk_jssdk_proto_depIdxs,
		MessageInfos:      file_protocol_jssdk_jssdk_proto_msgTypes,
	}.Build()
	File_protocol_jssdk_jssdk_proto = out.File
	file_protocol_jssdk_jssdk_proto_goTypes = nil
	file_protocol_jssdk_jssdk_proto_depIdxs = nil
}
