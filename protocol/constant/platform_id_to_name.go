...
var PlatformID2Name = map[int]string{
	...
	H5PlatformID:         H5PlatformStr,
	H5WebPlatformID:      H5WebPlatformStr,
}
...
var PlatformName2ID = map[string]int{
	...
	H5PlatformStr:         H5PlatformID,
	H5WebPlatformStr:      H5WebPlatformID,
}
...
var PlatformName2class = map[string]string{
	...
	H5PlatformStr:         H5PlatformStr,
	H5WebPlatformStr:      H5WebPlatformStr,
}
